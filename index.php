...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      <div class="vid-parent">
        <video playsinline autoplay muted loop>
          <source src="video/banvidf.mp4" />
        </video>
        <div class="vid-overlay"></div>
      </div>
      <div class="vid-content" >
        <h1 class="my-content">HI!  Welcome to ELearning</h1>
        <small class="my-content">Learning Is A Joy FOREVER</small><br />
        <?php    
    ...
    <div class="container-fluid bg-danger txt-banner"> <!-- Start Text Banner -->
        <div class="row bottom-banner">
          <div class="col-sm">
            <h5> <i class="fas fa-book-open mr-3"></i> Online Courses for many components</h5>
          </div>
          <div class="col-sm">
            <h5><i class="fas fa-water mr-3"></i>Smooth Sailing Courses</h5>
          </div>
          <div class="col-sm">
            <h5><i class="fas fa-keyboard mr-3"></i>Buy Once and use forever</h5>
          </div>
          <div class="col-sm">
            <h5><i class="fas fa-user mr-3"></i> Easy to Use</h5>
          </div>
        </div>
    </div> <!-- End Text Banner -->
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>ELearning is the best way to keep up with the growing market and at the same time learn about things you are interested in</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
            <a class="text-dark" href="#">Python</a><br />
            <a class="text-dark" href="#">Web Designing</a><br />
            <a class="text-dark" href="#"> App Dev</a><br />
          ...
          VIT VELLORE,<br />
          Tamil Nadu<br /> 
          Phone: +91 12345678890 <br />
          www.ELearning.com </p></div>
        </div>
      </div>
